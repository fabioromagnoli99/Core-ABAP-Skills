CLASS zcl_05_simple_internal_tables DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_05_simple_internal_tables IMPLEMENTATION.
...
"Table type (local) TYPES tt_strings TYPE TABLE OF string. DATA texts1 TYPE tt_strings.
" Table type (global) DATA texts2 TYPE string_table. " work areas
...
"Direct use of expression in string template out->write( |Content of row 1: { numbers[ 1 ] }| ).
